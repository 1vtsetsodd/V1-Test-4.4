...
bot = telebot.TeleBot('7252543397:AAH9sXsNnD8QI7EKWE7uCdNcXBabUjs59xU')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "\nभोसड़ीके 𝐂𝐡𝐚𝐭 𝐈𝐝 आईडी 𝐨𝐰𝐧𝐞𝐫 को भेजो 💀\nDM TO BUY ACCESS:- @NRJNIRAJ 🗿😈💥"
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username},\n😈𝗔𝗕 𝗛𝗢𝗚𝗔 𝗠𝗔𝗨𝗧 𝗞𝗔 𝗞𝗛𝗘𝗟💥\n\nतो शायरी कुछ ऐसी है 💀\n\nहवा चली पत्ते हिले\nमुट्ठ मारी टट्टे हिले\n\n🅃🄰🅁🄶🄴🅃 : {target}\n🄿🄾🅁🅃 : {port}\n🅃🄸🄼🄴 : {time} 𝓢𝓮𝓬𝓸𝓷𝓭𝓼\n🄼🄴🅃🄷🄾🄳 : 𝓥𝓲𝓹 𝓤𝓼𝓮𝓻 𝓸𝓯  @NRJNIRAJ"
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 10000:
                ...
                response = f"BGMI Attack Finished. Target: {target} Port: {port} Time: {time}\n\nअटैक खत्म हो गया है चूतिये, दूसरा मार ले🙆🏾‍♂️😅"
...
Buy From :- @NRJNIRAJ
Official Channel :- https://t.me/NRJ_DDOS
'''
...
3. Kill limit 15 to 20
4. We Daily Checks The Logs So Follow these rules to avoid Ban
5. MAKE SURE YOU JOINED https://t.me/NRJ_DDOS OTHERWISE NOT WORK!!'''
    bot.reply_to(message, response)
